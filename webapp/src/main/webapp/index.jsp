...
Whenever we commit any code changes to the project it automatically build pipeline gets triggered and it will build our project create war file and it places automatically to pipeline project home path
</h2>
